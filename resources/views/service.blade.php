        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                <div class="text-center bg-primary text-white p-4 rounded">
                    ...
                    <p class="mb-3">Contact us today to discuss your {{ strtolower($service->title) }} needs and get a custom quote.</p>
                    <a href="{{ route('contact') }}?service={{ urlencode($service->title) }}" class="btn btn-light btn-lg">Request This Service</a>
                </div>
